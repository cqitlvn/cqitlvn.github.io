...
function setup() {
  ...
  character1.addAnimation("down", new spriteAnimation(yellow, 6, 5, 6));
  character1.addAnimation("up", new spriteAnimation(yellow, 0, 5, 6));
  character1.addAnimation("right", new spriteAnimation(yellow, 0, 0, 9));
  character1.addAnimation("left", new spriteAnimation(yellow, 0, 0, 9));
  character1.addAnimation("stand", new spriteAnimation(yellow, 0, 0, 1));
  ...
  character2.addAnimation("right", new spriteAnimation(eskimo, 0, 0, 9));
  character2.addAnimation("left", new spriteAnimation(eskimo, 0, 0, 9));
